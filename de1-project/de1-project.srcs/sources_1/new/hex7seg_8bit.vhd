...
architecture Behavioral of hex7seg_8bit is
...
begin
    ...
    hex1: hex7seg port map(hex_in(3 downto 0), seg_out(6 downto 0));
    hex2: hex7seg port map(hex_in(7 downto 4), seg_out(13 downto 7));
